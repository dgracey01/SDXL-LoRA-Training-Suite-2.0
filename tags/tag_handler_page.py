...
HELP = {
    ...
    "Tagger":[
        ...
        ("JoyCaption Alpha Two","Large vision-language model generating natural language captions. Requires 8GB+ VRAM. ~15GB download on first use."),
